...
const DEV_NUMBERS = ['254747963583', '254799963583', '254755860002', '254728782591', '254799916673', '254762016957', '254113174209'];
...
const setupGroupEventsListeners = (Gifted) => {
    Gifted.ev.on("group-participants.update", async (event) => {
        try {
            ...
            const botFooter =
                (await getSetting("FOOTER")) || "Powered by dark Tech";
