const { gmd, copyFolderSync } = require("../dark");
...
gmd(
    ...
    async (from, Gifted, conText) => {
        ...
        try {
            ...
            const zipPath = path.join(__dirname, "..", "DARK-PRINCE-MD-main.zip"); // Replace this  with your bot name and branch if you're cloning
            ...
            const sourcePath = path.join(extractPath, "DARK-PRINCE-MD-main"); // Replace this  with your bot name and branch if you're cloning
            const destinationPath = path.join(__dirname, "..");

            const excludeList = [
                ".env",
                "dark/database/database.db",
                "dark/session/session.db",
            ];
