const { gmd, commands } = require("../dark/gmdCmds");
const {
  getSetting,
  setSetting,
  getAllSettings,
  resetSetting,
  resetAllSettings,
} = require("../dark/database/settings");
const {
  getGroupSetting,
  setGroupSetting,
  ...
  getAllGroupSettings,
} = require("../dark/database/groupSettings");
const { getSudoNumbers, clearAllSudo } = require("../dark/database/sudo");
const {
  getAllUsersNotes,
  deleteNoteById,
  updateNoteById,
...
gmd(
  ...
  async (from, Gifted, conText) => {
    ...
    if (!value) {
      ...
      const { getBadWords } = require("../dark/database/groupSettings");
