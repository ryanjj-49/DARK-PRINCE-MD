...
gmd(
  ...
  async (from, Gifted, conText) => {
    ...
    const { convertLidToJid } = require("../dark/connection/serializer");
...
gmd(
  ...
  async (from, Gifted, conText) => {
    ...
    const { downloadMediaMessage } = require("../dark/connection/serializer");
    const { isJidGroup } = require("gifted-baileys");
    ...
    try {
      ...
      if (msgType === "conversation" || msgType === "extendedTextMessage") {
        ...
        try {
          ...
          const altDownload =
            require("../dark/connection/serializer").downloadMediaMessage;
