...
gmd({
    ...
    react: "⬆️",
    category: "uploader",
    description: "Upload any file to DarkCDN",
}, async (from, Gifted, conText) => {
    await handleUpload(from, Gifted, conText, 'darkcdn');
});
...
async function handleUpload(from, Gifted, conText, service) {
    ...
    try {
        ...
        if (quotedImg) {
            ...
            if (service !== 'catbox' && service !== 'darkcdn' && service !== 'githubcdn') {
                return reply(`❌ ${service} only supports images. Use ${botPrefix}catbox or ${botPrefix}darkcdn or ${botPrefix}githubcdn  for videos and any other file type.`);
            }
            ...
            if (service !== 'catbox' && service !== 'darkcdn' && service !== 'githubcdn') {
                return reply(`❌ ${service} only supports images. Use ${botPrefix}catbox or ${botPrefix}darkcdn or ${botPrefix}githubcdn  for audios and any other file type.`);
            }
            ...
            if (service !== 'catbox' && service !== 'darkcdn' && service !== 'githubcdn') {
                return reply(`❌ ${service} only supports images. Use ${botPrefix}catbox or ${botPrefix}darkcdn or ${botPrefix}githubcdn  for documents and any other file type.`);
            }
        ...
        if (!isImage && service !== 'catbox' && service !== 'darkcdn' && service !== 'githubcdn') {
            return reply(`❌ ${service} only supports image files. Use ${botPrefix}catbox or ${botPrefix}darkcdn or ${botPrefix}githubcdn for any other file types.`);
        }
