...
const {
    ...
    endDiceGame,
    initDiceDB,
} = require("../dark/database/diceGame");
...
gmd({
    ...
    const { WcgDB } = require("../dark/database/wcgGame");
...
gmd({
    ...
    const rounds = parseInt(q) || 3;
    const { DiceDB } = require("../dark/database/diceGame");
