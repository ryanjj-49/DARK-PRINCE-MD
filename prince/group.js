const { gmd, getGroupMetadata, getLidMapping } = require("../dark");
const { getGroupSetting, setGroupSetting } = require("../dark/database/groupSettings");
...
gmd(
  ...
  async (from, Gifted, conText) => {
    ...
    const { isSuperUser } = require("../dark/database/sudo");
